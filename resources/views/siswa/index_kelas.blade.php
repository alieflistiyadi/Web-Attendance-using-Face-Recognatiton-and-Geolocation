        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mt-2">
                <div class="col-12">
                  <form action="/siswa/kelas/{{ $kelas }}" method="GET">
                    <div class="row">
                      <div class="col-6">
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <form action="/siswa/{{ $d->nis }}/delete" method="POST" style="margin-left: 5px">
                                @csrf
                                <input type="hidden" name="redirect_kelas" value="{{ $kelas }}">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="input-icon mb-3">
                    ...
                    <input type="text" value="" id="nama_lengkap_modal" class="form-control" name="nama_lengkap"
