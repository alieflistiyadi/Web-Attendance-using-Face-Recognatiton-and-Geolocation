<form action="{{ url('/siswa/'.$siswa->nis.'/update') }}" method="POST" id="formsiswa" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="col-12">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ $siswa->nama_lengkap }}" id="nama_lengkap" class="form-control" name="nama_lengkap" placeholder="Nama Siswa">
                              </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="input-icon mb-3">
                                ...
                                <input type="text" value="{{ $siswa->no_hp }}" id="no_hp" class="form-control" name="no_hp" placeholder="No HP">
                              </div>
                </div>
              </div>
              <div class="row mt-2">
                ...
                <div class="col-12">
                  <select name="kode_jurusan" id="kode_jurusan" class="form-select">
                      ...
                      @foreach ($jurusan as $d)
                          <option {{ $siswa->kode_jurusan == $d->kode_jurusan ? 'selected' : ''}} value="{{ $d->kode_jurusan }}">{{ $d->nama_jurusan}}</option>
                      @endforeach
                    </select>
                </div>
              </div>
