      ...
      <ul class="navbar-nav pt-lg-3">
        ...
        @if(Auth::guard('user')->user()->role === 'superadmin')
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#navbar-siswa" data-bs-toggle="dropdown" data-bs-auto-close="false"
          ...
          {{-- DATA IZIN / SAKIT --}}
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#navbar-izin" data-bs-toggle="dropdown" data-bs-auto-close="false"
              role="button" aria-expanded="false">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                  stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item" href="{{ route('attendance.laporan') }}">Presensi Siswa</a>
                  <a class="dropdown-item" href="{{ route('attendance.rekap') }}">Rekap Presensi Bulanan</a>
                </div>
              </div>
            </div>
          </li>
          ...
          {{-- KONFIGURASI --}}
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#navbar-konfigurasi" data-bs-toggle="dropdown"
              data-bs-auto-close="false" role="button" aria-expanded="false">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                  stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  ...
                  <a class="dropdown-item" href="{{ url('/konfigurasi/wali-kelas') }}">
                    Wali Kelas
                  </a>
                </div>
              </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('reset-requests.index') }}">
              ...
              <span class="nav-link-title">Permintaan Reset Password</span>
            </a>
          </li>
          ...
          {{-- MENU GURU --}}
          {{-- --}}
        @elseif(Auth::guard('user')->user()->role === 'guru')
          ...
          {{-- DATA IZIN / SAKIT --}}
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#navbar-izin-guru" data-bs-toggle="dropdown"
              data-bs-auto-close="false" role="button" aria-expanded="false">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                  stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          {{-- LAPORAN --}}
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#navbar-laporan-guru" data-bs-toggle="dropdown"
              data-bs-auto-close="false" role="button" aria-expanded="false">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                  stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
