            ...
            <div class="col">
                @if($cek > 0)
                    <button class="btn btn-danger btn-block" id="takeabsen">
                        <ion-icon name="refresh-outline"></ion-icon> Coba Lagi Kirim Absen Pulang
                    </button>
                @else
                    <button class="btn btn-primary btn-block" id="takeabsen">
                        <ion-icon name="refresh-outline"></ion-icon> Coba Lagi Kirim Absen Masuk
                    </button>
                @endif
            </div>
        </div>
            ...
            @else
                ...
                async function submitAttendance() {
                    ...
                    $.ajax({
                        ...
                        error: function () {
                            attendanceSubmitting = false;
                            setAutoStatus('Terjadi kesalahan koneksi.', 'alert-circle-outline', true);
