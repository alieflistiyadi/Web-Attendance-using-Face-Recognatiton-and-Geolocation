...
<head>
  ...
  <title>Login | Admin E-Attendance SMK SMART</title>
  <!-- CSS files -->
  ...
  <div class="page page-center">
    <div class="container container-tight py-4">
      <div class="text-center mb-4">
        <a href="." class="navbar-brand navbar-brand-autodark"><img src="{{ asset('/static/logo.svg')}}" height="36"
            alt=""></a>
      </div>
        ...
        <div class="card-body">
          ...
          <form action="/prosesloginadmin" method="post" autocomplete="off" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" class="form-control" placeholder="Email anda @email.com"
                autocomplete="off">
            </div>
            <div class="mb-2">
