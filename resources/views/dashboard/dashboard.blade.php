                            ...
                            <div class="presencecontent">
                                <div class="iconpresence">
                                    @if ($attendancehariini != null)
                                        ...
                                        @endphp
                                        <img src="{{ asset($path) }}" alt="foto_in" class="imaged w48 ">
                                    @else
                                ...
                                <div class="presencedetail">
                                    ...
                                    <span>{{ $attendancehariini != null ? $attendancehariini->jam_in : 'Belum Absen' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="presencecontent">
                                ...
                                <div class="presencedetail">
                                    ...
                                    <span>{{ $attendancehariini != null && $attendancehariini->jam_out != null ? $attendancehariini->jam_out : 'Belum Absen' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 10px; z-index: index 999;">{{ $rekapattendance->jmlhadir  }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 10px; z-index: index 999;">{{ $rekapizin->jmlizin }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 10px; z-index: index 999;">{{ $rekapizin->jmlsakit }}</span>
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span
                                            class="badge badge-danger">{{ $attendancehariini != null && $attendancehariini->jam_out != null ? $attendancehariini->jam_out : 'Belum Absen' }}</span>
                                    </div>
                                </div>
                            </li>
                        @endforeach
